            ...
            router.post('/', (req, res) => {
                ...
                const availableColumns = ['teacher_id'];
                ...
                const insertQuery = `INSERT INTO classRoom_student (${columns}) VALUES (${placeholders})`;
            ...
            router.get('/', (req, res) => {
                const selectQuery = 'SELECT * FROM classRoom_student';
            ...
            router.get('/:id', (req, res) => {
                const selectQuery = 'SELECT * FROM classRoom_student WHERE id = ?';
            ...
            router.put('/:id', (req, res) => {
                ...
                const updateQuery = `UPDATE classRoom_student SET ${updates} WHERE id = ?`;
            ...
            router.delete('/:id', (req, res) => {
                const deleteQuery = 'DELETE FROM classRoom_student WHERE id = ?';
