            ...
            router.post('/', (req, res) => {
                ...
                const availableColumns = ['firstName', 'lastName', 'id'];
                ...
                const insertQuery = `INSERT INTO classRoom_teacher (${columns}) VALUES (${placeholders})`;
            ...
            router.get('/', (req, res) => {
                const selectQuery = 'SELECT * FROM classRoom_teacher';
            ...
            router.get('/:id', (req, res) => {
                const selectQuery = 'SELECT * FROM classRoom_teacher WHERE id = ?';
            ...
            router.put('/:id', (req, res) => {
                ...
                const updateQuery = `UPDATE classRoom_teacher SET ${updates} WHERE id = ?`;
            ...
            router.delete('/:id', (req, res) => {
                const deleteQuery = 'DELETE FROM classRoom_teacher WHERE id = ?';
