            ...
            router.post('/', (req, res) => {
                ...
                const availableColumns = ['firstName', 'lastName', 'hairColor', 'toy', 'id'];
                ...
                const insertQuery = `INSERT INTO family_person (${columns}) VALUES (${placeholders})`;
            ...
            router.get('/', (req, res) => {
                const selectQuery = 'SELECT * FROM family_person';
            ...
            router.get('/:id', (req, res) => {
                const selectQuery = 'SELECT * FROM family_person WHERE id = ?';
            ...
            router.put('/:id', (req, res) => {
                ...
                const updateQuery = `UPDATE family_person SET ${updates} WHERE id = ?`;
            ...
            router.delete('/:id', (req, res) => {
                const deleteQuery = 'DELETE FROM family_person WHERE id = ?';
